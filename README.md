...
* automatically [finds and adds Boost unit tests](https://github.com/R3D9477/UCMakeSkeleton/blob/main/CMakeLists.txt#L270) *(**don't use** the dot symbol '.' in the name of test's source file!)*
